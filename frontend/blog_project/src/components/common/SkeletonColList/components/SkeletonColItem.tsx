...
export interface SkeletonColItemProps {}

export function SkeletonColItem(props: SkeletonColItemProps) {
    return (
        <div className="flex gap-4 py-4 border-b border-b-gray-300 animate-pulse first:pt-0 last:border-0">
